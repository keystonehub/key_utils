...
local function check_version(opts)
    ...
    -- DEBUG PRINT
    print("[VERSION CHECK] Current version for " .. resource_name .. ": " .. tostring(current_version))
...
local opts = {
    resource_name = 'fivem_utils',
    url_path = 'keystonehub/fivem_resource_versions/refs/heads/main/versions.json',
}
check_version(opts)
