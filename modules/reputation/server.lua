...
local reputation_list = utils.get_shared_data('reputation')
...
local function insert_new_reputation(_src, reputation_name, reputation_data)
    local columns, values, params = framework.get_insert_params(_src, 'reputation', reputation_name, reputation_data)
...
local function get_reputations(_src)
...
--- @usage reputation.get_reputation(player_source, reputation_name)
...
local function modify_reputation(_src, reputation_name, value, operation)
    ...
    if not all_reputation_data[reputation_name] then
        ...
        local default_reputation_data = {
            level = reputation_list[reputation_name].level,
            current_rep = reputation_list[reputation_name].start_rep,
            required_rep = calculate_required_rep(reputation_list[reputation_name].level, reputation_list[reputation_name].first_level_rep, reputation_list[reputation_name].growth_factor),
            first_level_rep = reputation_list[reputation_name].first_level_rep,
            growth_factor = reputation_list[reputation_name].growth_factor,
            max_level = reputation_list[reputation_name].max_level
        }
...
reputation.modify_reputation = modify_reputation
...
callbacks.register('fivem_utils:sv:get_reputations', fetch_player_reputations)
