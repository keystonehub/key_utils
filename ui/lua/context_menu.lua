...
utils.context_menu = create_context_menu
...
--- Command to open the context menu for testing
RegisterCommand('ui:test_context', function()
    local test_menu = {
        header = {
            title = 'User Options',
