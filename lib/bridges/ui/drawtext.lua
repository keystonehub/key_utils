...
if ENV.IS_SERVER then 
    ...
    local function show_drawtext(source, options)
        ...
        TriggerClientEvent("key_utils:cl:drawtext_show", source, options)
    end
    ...
    local function hide_drawtext(source)
        ...
        TriggerClientEvent("key_utils:cl:drawtext_hide", source)
    end
    ...
    local HANDLERS <const> = {
        default = {
            show = function(options)
                TriggerEvent("key_utils:show_drawtext", options)
            end,
            hide = function()
                TriggerEvent("key_utils:hide_drawtext")
            end
        },
        boii = {
            show = function(options)
